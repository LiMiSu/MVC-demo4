...
},{"process":"hKAc"}],"BQVr":[function(require,module,exports) {
"use strict";
...
var Model = /*#__PURE__*/function (_EventBus) {
  ...
  function Model(options) {
    ...
    _this = _super.call(this); //调用EventBus的constructor才能继承它constructor里面的东西
  ...
  _createClass(Model, [{
    ...
    value: function _delete() {
      ...
      (_console = console) === null || _console === void 0 ? void 0 : (_console$error = _console.error) === null || _console$error === void 0 ? void 0 : _console$error.call(_console, '你还没实现 delete');
    }
  }, {
    key: "update",
...
var View = /*#__PURE__*/function (_EventBus) {
  ...
  function View(options) {
    ...
    _this.render(_this.container, _this.data);

    _this.autoBindEvents(_this.container);
  ...
  _createClass(View, [{
    key: "autoBindEvents",
    value: function autoBindEvents(container) {
...
var init = function init(container) {
  new _View.default({
    ...
    render: function render(container, data) {
      ...
      (0, _jquery.default)(this.html.replace('{{n}}', this.data.n)).appendTo((0, _jquery.default)(container));
    },
    events: {
      'click #add1': 'add',
      'click #minus1': 'minus',
...
var init = function init(container) {
  ...
  new _View.default({
    ...
    render: function render(container, data) {
      (0, _jquery.default)(container).empty();
      (0, _jquery.default)(this.html(this.data.index)).appendTo((0, _jquery.default)(container));
    },
    events: {
...
var _default = init;
exports.default = _default;
},{"./app2.css":"AQoi","jquery":"juYr","./base/Model.js":"wYwp","./base/View":"SFHW","./base/EventBus":"BQVr"}],"y8lT":[function(require,module,exports) {
"use strict";
...
var view = {
  ...
  init: function init(container) {
    ...
    view.autoBindEvents(container); //监听m
  ...
  render: function render(container, active) {
    (0, _jquery.default)(container).empty();
    (0, _jquery.default)(view.html(active)).appendTo((0, _jquery.default)(container));
  },
  events: {
    'click .square': 'move'
  },
...
var _default = view;
exports.default = _default;
},{"./app3.css":"AQoi","jquery":"juYr","./base/Model":"wYwp"}],"eWpN":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=main.47248885.js.map